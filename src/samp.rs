...
impl From<v037r5::Gamestate> for Gamestate {
    fn from(state: v037r5::Gamestate) -> Self {
        match state {
            v037r5::Gamestate::None => Gamestate::None,
            v037r5::Gamestate::WaitConnect => Gamestate::WaitConnect,
            v037r5::Gamestate::Connecting => Gamestate::Connecting,
            v037r5::Gamestate::Connected => Gamestate::Connected,
            v037r5::Gamestate::AwaitJoin => Gamestate::AwaitJoin,
            v037r5::Gamestate::Restarting => Gamestate::Restarting,
        }
    }
}
...
pub fn gamestate() -> Gamestate {
    match version() {
        ...
        Version::V037R5 => v037r5::CNetGame::get()
            .map(|netgame |netgame.gamestate().into())
            .unwrap_or(Gamestate::None),
        _ => Gamestate::None,
    }
