...
pub struct NetGame<'a> {
    ...
    netgame_v5: Option<& 'a mut v037r5::CNetGame>
}
...
impl<'a> NetGame<'a> {
    pub fn get() -> NetGame<'a> {
        match version() {
            ...
            Version::V037R5 => NetGame {
                netgame_v1: None,
                netgame_v3: None,
                netgame_v5: v037r5::CNetGame::get()
            },
    ...
    pub fn addr(&self) -> Option<SocketAddr> {
        match version() {
            ...
            Version::V037R5 => self.netgame_v5.as_ref().and_then(|netgame| netgame.addr()),
            _ => None,
        }
    }
