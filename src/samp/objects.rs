use super::{v037r3 as r3, v037 as r1, v037r5 as r5};
...
impl<'a> Object<'a> {
    ...
    fn new_v5(object: &'a r5::CObject) -> Object<'a> {
        Object {
            object_v5: Some(object),
            object_v3: None,
            object_v1: None,
        }
    }
    ...
    pub fn entity(&self) -> Option<&'a mut CObject> {
        ...
        let v5 = self.object_v5.map(|obj | obj._base.m_pGameEntity as *mut CObject);
    ...
    pub fn get(object_id: i32) -> Option<Object<'a>> {
        match version() {
            ...
            Version::V037R5 => r5::find_object(object_id).map(|obj| Object::new_v5(obj)),
